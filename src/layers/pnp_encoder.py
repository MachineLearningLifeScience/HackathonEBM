...
class PNPEncoder(nn.Module):
    """
    Implements the PNP Encoder for handling missing data in a Partial VAE (PVAE) model.
    ...
    def __init__(self,
        ...
        self.h = nn.Sequential(
            MLP(input_dim=emb_dim, hidden_dims=[], output_dim=h_dim),
            nn.ReLU()
        )
    ...
    def forward(self, x, mask):
        ...
        # Multiply x_d * e_d (element-wise multiplication across embedding dim)
        s = x_exp * e_exp                       # [B, D, emb_dim]
